---
name: "audit-runtime-surface"
description: "Audita scripts, bin wrappers y hooks del runtime."
argument-hint: "$ARGUMENTS"
user-invocable: true
disable-model-invocation: false
allowed-tools: Read, Glob, Grep, Bash, Agent, Skill
---
# audit-runtime-surface

This is the active Claude Code project skill for `/audit-runtime-surface`. It is self-contained and delegates directly to scripts, hooks, trailers and generated state.
...
```bash
./scripts/audit-runtime-surface.sh $ARGUMENTS
```
